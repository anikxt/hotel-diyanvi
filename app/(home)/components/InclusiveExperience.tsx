    ...
    <div className="bg-primary min-h-screen flex flex-col items-center">
      ...
      <div className="flex justify-center gap-12 mt-32 w-[90%] border-b-2 border-b-gray-400 border-opacity-80 pb-20">
        ...
        <div className="flex flex-col gap-10">
          <p className="text-menu-1 font-roboto font-medium text-base leading-snug max-w-[52ch]">
      ...
      <div className="flex justify-center gap-12 mt-32 w-[90%] border-b-2 border-b-gray-400 border-opacity-80 pb-20">
        <div className="flex flex-col gap-4 w-[30%]">
          ...
          <span className="font-roboto text-base flex flex-col gap-2 max-w-[52ch]">
            <p>
              <span className="text-xl">&#x1F449;</span>{' '}
              <span className="text-primary font-bold">Perfect For:</span>{' '}
        ...
        <div className="flex flex-col gap-10">
          <p className="text-menu-1 font-roboto font-medium text-base leading-snug max-w-[51ch]">
      ...
      <div className="flex justify-center gap-12 mt-32 w-[90%] border-b-2 border-b-gray-400 border-opacity-80 pb-20">
        <div className="flex flex-col gap-4 w-[30%]">
          ...
          <span className="font-roboto text-base flex flex-col gap-2 max-w-[51ch]">
            <p>
              <span className="text-xl">&#x1F449;</span>{' '}
              <span className="text-primary font-bold">Perfect For:</span>{' '}
      ...
      <div className="flex justify-center gap-12 mt-32 w-[90%] mb-32">
        <div className="flex flex-col gap-4 w-[30%]">
          ...
          <span className="font-roboto text-base flex flex-col gap-2 max-w-[46ch]">
            <p>
              <span className="text-xl">&#x1F449;</span>{' '}
              <span className="text-primary font-bold">Perfect For:</span>{' '}
