        ...
        <div className="flex flex-col justify-center items-center gap-8 mt-16">
          ...
          <div className="text-secondary font-roboto text-center text-sm sm:text-base md:text-lg font-medium leading-normal tracking-tight flex flex-col justify-center items-center gap-4 max-w-[36ch] sm:max-w-prose">
            ...
            <p className="hidden sm:block max-w-[64ch]">
              Tucked away in the regal city of Mysuru, Hotel Diyanvi redefines
              the art of indulgence. A 5-star luxury hotel crafted for those who
              ...
              team ensures your stay is seamless and unforgettable.Whether
              you're here for a boardroom meeting, a romantic escape, or a
              soul-stirring getaway, Hotel Diyanvi embraces you with heartfelt
